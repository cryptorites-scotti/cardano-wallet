...
module Cardano.Wallet.Shelley.TransactionSpec where
...
balanceTransactionSpec = do
    describe "balanceTransaction" $ do
        ...
        -- it "works as expected when varying balance"
        prop_balanceTransactionIncreaseWalletBalance
...
data SimplePlutusBalanceGolden =
    SimplePlutusBalanceGolden
        { walletCoin :: Coin
        , balancedFee :: Cardano.Lovelace
        , balancedMinFee :: Cardano.Lovelace
        }
    | BalanceGoldenFailure Coin String

instance Buildable SimplePlutusBalanceGolden where
    build (BalanceGoldenFailure c err) = mconcat
        [ build c
        , ",,,"
        , build (T.pack err)
        ]
    build (SimplePlutusBalanceGolden c fee minfee) = mconcat
        [ build c
        , ","
        , lovelaceF fee
        , ","
...
goldenText :: String -> [SimplePlutusBalanceGolden] -> Golden Text
goldenText name res =
    Golden
...
prop_balanceTransactionIncreaseWalletBalance
    :: Spec
prop_balanceTransactionIncreaseWalletBalance = describe "balance goldens" $ do
    describe "fees with low wallet balance on 1 UTxO" $ do
        it "balancing ping_pong_1" $
            goldenText "1_utxo_ping_pong_1"
                (mapMaybe (mkGolden pingPong_1 1 . Coin)
                [0, 50_000 .. 4_000_000])

        it "balancing ping_pong_2" $
            goldenText "1_utxo_ping_pong_2"
              (mapMaybe (mkGolden pingPong_2 1 . Coin)
                [0, 100_000 .. 8_000_000])

    describe "fees with low balance on 2 UTxOs" $ do
        it "balancing ping_pong_1" $
            goldenText "2_utxo_ping_pong_1"
                (mapMaybe (mkGolden pingPong_1 2 . Coin)
                [0, 25_000 .. 2_000_000])
  where
    mkGolden partialTx n c =
        case testCase (replicate n c) partialTx of
            Right tx
                -> Just $ SimplePlutusBalanceGolden c (txFee tx) (txMinFee tx)
            Left e
                -> Just $ BalanceGoldenFailure c (show e)
    ...
    testCase coins partialTx = do
        let Wallet' utxoIndex wal pending = mkTestWallet rootK (utxo coins)
        balanceTransaction'
    ...
    pingPong_1 = PartialTx tx [] []
      where
        Right tx = sealedTxFromBytes $ unsafeFromHex "84a500800d80018183581d714d72cf569a339a18a7d9302313983f56e0d96cd45bdcb1d6512dca6a1a001e84805820923918e403bf43c34b4ef6b48eb2ee04babed17320d8d1b9ff9ad086e86f44ec02000e80a10481d87980f5f6"

    pingPong_2 :: PartialTx
    pingPong_2 = PartialTx
        { sealedTx = either (error . show) id $ sealedTxFromBytes $ (unsafeFromHex "84a50081825820") <> bytes tid <> (unsafeFromHex "")
        , inputs =
            [ ( TxIn tid 0
        ...
        case res of
            Right sealedTx -> counterexample ("\nResult: " <> pretty sealedTx) $ do
                label "success"
                    ...
                    .&&.
                    -- FIXME: burning 1.2 ada on fees should never happen!
            ...
            Left (ErrBalanceTxUnableToMinimizeFee _deficit) ->
                label "unable to minimize fee" $ property True
